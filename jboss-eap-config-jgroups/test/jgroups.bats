...
# this makes CI very unhappy and doesn't show any output
#set -euo pipefail
#IFS=$'\n\t'
...
export LOGGING_INCLUDE=$BATS_TEST_DIRNAME/logging.sh
...
@test "Configure JGROUPS_PROTOCOL=SYM_ENCRYPT" {
    expected=$(cat <<EOF
<?xml version="1.0"?>
   <1encrypt-protocol type="SYM_ENCRYPT" key-store="keystore" key-alias="key_alias">
