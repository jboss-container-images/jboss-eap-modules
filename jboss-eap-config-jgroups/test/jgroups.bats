...
export TEST_ELYTRON_INCLUDE=$BATS_TEST_DIRNAME/../../jboss-eap-config-elytron/added/launch/elytron.sh
export TEST_NODE_NAME_INCLUDE=$BATS_TEST_DIRNAME/../../test-common/node-name.sh
