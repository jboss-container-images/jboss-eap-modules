...
Feature: Wildfly extensions tests
  ...
  Scenario: Test preconfigure.sh
    Given s2i build git://github.com/jboss-container-images/jboss-eap-modules from tests/examples/test-app-advanced-extensions with env and True using master
      | variable                             | value         |
    ...
    And check that page is served
      ...
      | path     | /     |
      | port     | 8080  |
    Then XML file /opt/eap/standalone/configuration/standalone-openshift.xml should contain value foo on XPath //*[local-name()='property' and @name="foo"]/@value
   ...
   Scenario: Test preconfigure.sh calls CLI
    ...
    And check that page is served
      ...
      | path     | /     |
      | port     | 8080  |
    Then XML file /opt/eap/standalone/configuration/standalone-openshift.xml should contain value bar on XPath //*[local-name()='property' and @name="foo"]/@value
  ...
  Scenario: Test postconfigure.sh calls CLI
    ...
    And check that page is served
      ...
      | port     | 8080  |
    Then XML file /opt/eap/standalone/configuration/standalone-openshift.xml should contain value bar on XPath //*[local-name()='property' and @name="foo"]/@value
    Then XML file /opt/eap/standalone/configuration/standalone-openshift.xml should contain value bar2 on XPath //*[local-name()='property' and @name="foo2"]/@value
