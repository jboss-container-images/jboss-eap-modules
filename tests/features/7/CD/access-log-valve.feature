...
Feature: EAP Openshift access-log-valve and log handler tests
  ...
  Scenario: Access Log valve, No undertow should give error
   ...
   Then container log should contain You have set ENABLE_ACCESS_LOG=true to add the access-log valve. Fix your configuration to contain the undertow subsystem for this to happen.
