...
Feature: EAP Openshift access-log-valve and log handler tests
  ...
  Scenario: Added server with no hosts should not have access-log valve to the added server
    When container is started with command bash
       | variable                   | value         |
       | ENABLE_ACCESS_LOG          | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-empty-server.cli to /tmp in container
  ...
  Scenario: Added server with two hosts should have acesss-log added to both the new hosts
    When container is started with command bash
       | variable                   | value         |
       | ENABLE_ACCESS_LOG          | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-server-with-two-hosts.cli to /tmp in container
  ...
  Scenario: Existing access-log with matching values should not give error
    When container is started with command bash
       | variable                   | value         |
       | ENABLE_ACCESS_LOG          | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-matching-access-log.cli to /tmp in container
  ...
  Scenario: Existing access-log with clashing values should give error
    When container is started with command bash
       | variable                   | value         |
       | ENABLE_ACCESS_LOG          | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-clashing-access-log.cli to /tmp in container
  ...
  Scenario: Existing logger category with matching level should not give error
    When container is started with command bash
       ...
       | ENABLE_ACCESS_LOG          | true          |
       | ENABLE_ACCESS_LOG_TRACE    | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-matching-logger.cli to /tmp in container
  ...
  Scenario: Existing logger category with clashing level should not give error
    When container is started with command bash
       ...
       | ENABLE_ACCESS_LOG          | true          |
       | ENABLE_ACCESS_LOG_TRACE    | true          |
    Then copy features/jboss-eap-modules/7/scripts/access-log-valve/add-clashing-logger.cli to /tmp in container
